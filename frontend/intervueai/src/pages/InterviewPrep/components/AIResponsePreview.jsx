      ...
      <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
        <ReactMarkdown
          ...
          components={{
            ...
            p({ children }) {
              return <p className="tmb-4 leading-5">{children}</p>;
            },
            strong({ children }) {
            ...
            ul({ children }) {
              return (
                <ul className="list-disc pl-6 space-y-4 my-4">{children}</ul>
              );
            },
            ol({ children }) {
              return (
                <ol className="list-decimal pl-6 space-y-4 my-4">{children}</ol>
              );
            },
            li({ children }) {
    ...
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        <div className="flex items-center space-x-2">
          <LuCode className="text-gray-500" size={16} />
