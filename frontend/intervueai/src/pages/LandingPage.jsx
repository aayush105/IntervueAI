...
import LOGO_ICON from "../assets/IntervueAI.png";
      ...
      <div className="w-full min-h-full bg-[#FFFCEF]">
        ...
        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          ...
          <header className="flex justify-between items-center mb-16">
            ...
            <img src={LOGO_ICON} alt="Hero Image" className="w-28 sm:w-40" />
            {user ? (
              <ProfileInfoCard />
            ) : (
              <button
                className="bg-linear-to-r from-[#FF9324] to-[#c99a4b] text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-black hover:text-white border border-white transition-colors cursor-pointer"
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2">
              <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                ...
                Free preparation to mastery - your ultimate interview toolkit is
                here,
              </p>
          ...
          <div className="container mx-auto px-4 pt-10 pb-20">
            <section className="mt-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {APP_FEATURES.map(
                  (
                    { id, title, description, icon: Icon, iconClass },
                    index
                  ) => (
                    <div
                      key={id}
